							...
							<div class="spotlights">
								<div class="spotlight">
									<div class="content" style="width: 100%;">
										...
										<a onclick="sendBoard()" class="button small fit" style="font-size: 20px">등록</a>
										<a href="/board/boardList${cri.getListLink()}"class="button primary small fit" style="font-size: 20px">돌아가기</a>
									</div>
								</div>
							</div>
						</div>
