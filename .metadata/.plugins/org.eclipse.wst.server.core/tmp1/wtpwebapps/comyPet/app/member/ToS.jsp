				...
				<div class="box box-border">
					<div class="box-body">
						...
						<div class="form-group">
							<textarea name="tosMesseage" rows="10" class="form-control" style="resize: none; width: 100%;" readonly>
시행일자 : 2020년 08월 28일

제1조 (목적)
본 약관은 주식회사(이하 '회사')가 고도 사이트(이하 ‘사이트’)를 통하여 인터넷상에서 제공하는 서비스(이하 ‘서비스’)를 이용하는 고객 (이하 '고객')간의 권리와 의무 및 책임 등 기타 제반사항을 규정함을 목적으로 합니다.
...
부칙 (시행일)
본 약관은 2020년 8월 28일부터 적용하고, 2016년 5월 2일부터 시행되던 종전의 약관은 본 약관으로 대체합니다.
							</textarea>
						</div>
						<div class="form-group">
							<label>
								<input type="checkbox" name="agree_1">
								<span style="color:red; font-weight:800">[필수]</span> 이용 약관에 동의
							</label>
						</div>
						<div class="form-group">
							<textarea name="tosMesseage" rows="10" class="form-control" style="resize: none; width: 100%;" readonly>
...
본 약관은 2020년 8월 28일부터 적용하고, 2016년 5월 2일부터 시행되던 종전의 약관은 본 약관으로 대체합니다.
						...
						<div class="form-group">
							<label>
								...
								<span style="color:red; font-weight:800">[필수]</span> 개인정보 수집 및 이용 동의
							</label>
						</div>
						<!-- 이 버튼 누르면 위의 버튼 2개가 자동으로 눌린다. 
								마찬가지로 위의 버튼 2개를 누르면 밑에 모두 동의 버튼도 눌린다.
						-->
						<div class="form-group" style="text-align:center">
							<label>
								<input type="checkbox" name="agree_all">
								이용 약관 및 개인정보 수집 및 이용에 모두 동의
							</label>
						</div>
						<div class="form-group" style="text-align:center">
							<!-- <a href="/app/member/join.jsp" class="btn btn-primary" style="width:33%">동의</a> -->
							<button class="btn btn-primary" onclick="agree_ok()" style="width: 33%">동의</button>
