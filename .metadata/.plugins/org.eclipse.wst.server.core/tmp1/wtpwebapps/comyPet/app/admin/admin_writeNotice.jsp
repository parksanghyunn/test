	...
	<section class="home">
		<div class="container">
			<form method="post" id="board" enctype="multipart/form-data">
				<input type="text" id="summernote_title" name="board_title" class="form-control" placeholder="제목을 입력해주세요.">
				<textarea id="summernote" name="board_contents" style="resize: none;"></textarea>
				<div class="box box-border">
					...
					<input type="hidden" id="summernote_state" name="board_state" value="0"/>
				</div>
			</form>
		</div>
	</section>
