				...
				<div class="col-md-8 text-left">
					...
					<div class="row">
						<div class="col-md-12">
							<ol class="breadcrumb">
								<li><a href="#">고객센터</a></li>
								<li class="active">이용약관 및 개인정보취급방침</li>
							</ol>
						</div>

						<div class="line" style="margin: 10px"></div>
						<ul class="nav nav-tabs nav-justified" role="tablist">
							<li class="active"><a href="#policy_1" aria-controls="policy_1" role="tab" data-toggle="tab">이용약관</a></li>
							<li><a href="#policy_2" aria-controls="policy_2" role="tab" data-toggle="tab">개인정보취급방침</a></li>
						</ul>
						<div class="tab-content">
						<div class="tab-pane policy_1 active" id="policy_1">
							<textarea name="policyMessage_1" rows="35" class="form-control" style="resize: none; width: 100%;" readonly>
제1조(목적)
...
부  칙
제 1 조 (시행일) 이 약관은 2020년 11월 00일부터 시행한다.      
							</textarea>
						</div>
						<div class="tab-pane policy_2" id="policy_2">
							<textarea name="policyMessage_2" rows="35" class="form-control" style="resize: none; width: 100%;" readonly>
