         ...
         <center>
            <table  border="1" cellpadding="0" cellspacing="0" width="25%">
               ...
               <tr height="40px">
                  ...
                  <td><input type="text" name="member_id" style="width:200px;" />
                  <!-- <input type="button" value = "중복확인" onclick = "check(form.member_id.value)"> -->
                  <p id = "checkId">아이디를 입력해주세요.</p>
                  </td>
               </tr>
               <tr height="40px">
               ...
               <tr height="40px">
                  ...
                  <td>
                  <input type="text" name="member_zipcode" class="postcodify_postcode5" value="" readonly/>
               ...
               <tr height="40px">
                  ...
                  <td>
                     <input type="text" name="member_address" class="postcodify_address" value="" style="width:280px;" readonly/><br />
                  </td>
               </tr>
               <tr height="40px">
                  <td align="center" width="100px">상세주소</td>
                  <td>
                     <input type="text" name="member_address_detail" class="postcodify_details" value="" style="width:280px;" /><br />
                  </td>
               </tr>
               <tr height="40px">
                  <td align="center" width="100px">참고항목</td>
                  <td>
                     <input type="text" name="member_address_etc" class="postcodify_extra_info" value="" style="width:280px;" readonly /><br />
                  </td>
               </tr>
               <tr height="40px">
