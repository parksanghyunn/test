...
public class BoardDAO {
	...
	/*댓글*/
	//댓글 추가시, 사용자가 작성한 새로운 댓글 정보를 전달받는다
	...
	public void deleltReply(int reply_num) {
		sqlsession.delete("Board.deleteReply", reply_num);
	}
	public void deletBoardReply(int board_num) {
		sqlsession.delete("Board.deleteBoardReply",board_num);
	}
